  ...
  <el-dialog
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="100px" @keyup.enter.native="dataFormSubmit()">
      ...
      <el-form-item label="管理员权限" prop="isAdmin">
        <el-select v-model="dataForm.isAdmin" clearable class="filter-item" style="width: 110px">
...
const defaultDataForm = { id: 0, username: '', nickname: '', email: '', avatar: undefined, password: '', isAdmin: 3, isDisable: false }
