...
public class BlogLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            blogLog.setOperatingSystem(getName(operatingSystem));
            blogLog.setOperatingSystemName(operatingSystem);
            String browser = userAgent.getBrowser().getName();
            blogLog.setBrowser(getName(browser));
            blogLog.setBrowserName(browser);
            //请求类型
    ...
    public static String getName(String name) {
        name = name.replaceAll("([1-9]+[0-9]*|0)(\\.[\\d]+)?", "");
        return name;
    }
