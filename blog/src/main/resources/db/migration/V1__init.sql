...
-- 添加初始数据
INSERT INTO `blog_config`(`name`, `value`, `type`, `description`,`is_delete`)
VALUES ('BLOG_TITLE', '我的个人博客', '1', '网站标题',0),
       ('BLOG_KEYWORDS', '个人博客,博客', '1', '网站关键词，关键字之间用,分隔',0),
       ('BLOG_DESCRIPTION', '这是我的个人博客', '1', '网站描述',0),
       ('BLOG_URL', 'http://127.0.0.1:8080/', '1', '网站链接',0),
       ('BLOG_AUTHOR', 'admin', '1', '网站作者',0),
       ('BLOG_AVATAR', '/images/avatar.jpg', '1', '头像',0),
       ('BLOG_NOTICE', '这是公告', '1', '公告',0),
       ('DEFAULT_IMAGE', '/images/default-preview.jpg', '1', '默认预览图',0),
       ('AUTHOR_DESCRIPTION', '一二三四五，上山打老虎。', '1', '头像下的描述内容',0),
       ('FILING_ICP', null, '1', 'ICP备案',0),
       ('FILING_SECURITY', null, '1', '公安备案',0),
       ('COMMENT_CHECK', 'false', '2', '评论是否需要校检',0),
       ('BACKGROUND_LIST',
...
INSERT INTO `blog_category` (`id`, `name`, `url`,`is_delete`) VALUES ('1', '未分类', 'default',);
...
INSERT INTO `blog_article`(`id`, `url`, `title`, `description`, `image`, `content`, `content_md`,
                           ...
                           `source_url`, `visits`, `type`, `status`,`is_delete`)
VALUES ('1', 'hello-world', 'hello world!', '你好，世界', null,
       ...
       ('2', 'about', '关于我', '关于我', null,
        ...
        '<p style=\"text-align: center;\">\r\n	<span style=\"font-size: 14pt;\">欢迎来到<strong>我的个人博客</strong></span>\r\n</p>\r\n<div class=\"alert alert-danger\">我是一个好人。<br>我真的是一个好人哦！\r\n</div>\r\n<div class=\"alert alert-success\">这是个自定义文章示例界面<br>内容完全自定义<br>嘿嘿嘿~</div>\r\n<div class=\"alert alert-danger\">博客项目在<a href=\"https://github.com/iszhouhua/blog\">这里https://github.com/iszhouhua/blog</a><br>参考的博客主题在<a href=\"https://github.com/ZEROKISEKI/hexo-theme-gal\">这里https://github.com/ZEROKISEKI/hexo-theme-gal</a><br>参考网站在<a href=\"https://www.mmgal.com/\">这里https://www.mmgal.com/</a></div>',
        null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '0', '1', '1', null, '0', '1', '1',0);

INSERT INTO `blog_link`(`id`, `name`, `url`, `type`,`is_delete`)
VALUES ('1', '周华个人博客', 'https://www.iszhouhua.com', '1',0),
       ('2', 'GitHub', 'https://iszhouhua.github,io', '2',0);

INSERT INTO `blog_menu`(`id`, `name`, `url`, `is_blank`, `icon`, `sort`,`is_delete`)
VALUES ('1', '首页', '/', '0', 'fa-home', '1'),
       ('2', '分类', '/category/', '0', 'fa-list', '3'),
       ('3', '标签', '/tag/', '0', 'fa-tags', '4'),
       ('4', '关于我', '/about.html', '0', 'fa-user', '10',0);

INSERT INTO `blog_spider`(`id`, `name`, `title_rule`, `content_rule`,`is_delete`)
VALUES ('1', '博客园', 'h1.postTitle', 'div.postBody',0),
       ('2', 'CSDN', 'h1.title-article', 'div#content_views',0),
       ('3', '简书', 'h1.title', 'div.show-content',0),
       ('4', '思否', '#articleTitle a', 'div.article',0);

INSERT INTO `blog_user`(`id`, `username`, `nickname`, `password`, `salt`, `email`, `is_admin`, `last_login_time`,
                        `create_time`, `login_fail_num`, `is_disable`, `avatar`,`is_delete`)
VALUES ('1', 'admin', '管理员', 'f592d0ce304114b279e85b18f804334b', '7af4a47cb431d8f4', 'admin@admin.com',
        b'1', null, CURRENT_TIMESTAMP, '0', '0', '/images/avatar.jpg',0);